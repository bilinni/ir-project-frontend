import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { MongoClient } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/mongodb/lib/index.js';
import { createObjectCsvStringifier } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/csv-writer/dist/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/devalue/index.js';
import destr from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/ufo/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/vue/index.mjs';
import { hash } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/nikita/Desktop/gitir/ir-project/node_modules/@unhead/shared/dist/index.mjs';
...
const _hHkkctIbFG = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/nikita/Desktop/gitir/ir-project";
...
const _lazy_Ce5e7y = () => Promise.resolve().then(function () { return questions$1; });
const _lazy_qBhflP = () => Promise.resolve().then(function () { return results$1; });
const _lazy_Ik5S64 = () => Promise.resolve().then(function () { return submit$1; });
const _lazy_lV5bV9 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/questions', handler: _lazy_Ce5e7y, lazy: true, middleware: false, method: undefined },
  { route: '/api/results', handler: _lazy_qBhflP, lazy: true, middleware: false, method: undefined },
  { route: '/api/submit', handler: _lazy_Ik5S64, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_lV5bV9, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_lV5bV9, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"/home/nikita/Desktop/gitir/ir-project/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/nikita/Desktop/gitir/ir-project","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/nikita/Desktop/gitir/ir-project/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/nikita/Desktop/gitir/ir-project/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/nikita/Desktop/gitir/ir-project/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/nikita/Desktop/gitir/ir-project/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const questions = defineEventHandler(async (event) => {
  const config = useRuntimeConfig();
...
const questions$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: questions
});

const results = defineEventHandler(async (event) => {
  const config = useRuntimeConfig();
  const client = await MongoClient.connect(config.mongoUri, {});
  try {
    const db = client.db(config.mongoDb);
...
const results$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: results
});
...
const submit = defineEventHandler(async (event) => {
  ...
  if (!body.user || !Array.isArray(body.answers)) {
    return {
      success: false,
...
const submit$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: submit
});
...
const getClientManifest = () => import('file:///home/nikita/Desktop/gitir/ir-project/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
